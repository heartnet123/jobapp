# Agent Guidelines & Quality Rules

## Oxlint Quality Assurance Rule

Whenever you create or modify any JavaScript, TypeScript, or Vue files (`.js`, `.jsx`, `.ts`, `.tsx`, `.vue`, `.mjs`, `.cjs`), you **MUST** run `oxlint` to ensure high code quality:
