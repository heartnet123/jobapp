import type { Stage, JobApplication, ActivityLogEntry } from '@jobapp/shared';
...
/**
 * Normalizes a Stage name to a lowercase class name suffix (e.g. "Take-home" -> "take-home").
 */
...
export function detectChangesAndGenerateLogs(oldApp: JobApplication, newApp: JobApplication): ActivityLogEntry[] {
  ...
  fieldsToCompare.forEach(({ key, label, isUrl }) => {
