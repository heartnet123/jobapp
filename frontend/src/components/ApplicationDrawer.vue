...
import type { JobApplication, Stage, ChecklistItem, Contact } from '@jobapp/shared';
import { STAGES as stages, WORK_MODES as workModes } from '@jobapp/shared';
...
/* -------------------------------------------------------------
 * RESPONSIVE MOBILE FORM REFITTING
 * ------------------------------------------------------------- */
